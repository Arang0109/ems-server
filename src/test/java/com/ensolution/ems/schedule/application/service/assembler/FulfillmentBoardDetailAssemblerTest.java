 ...
 */
class FulfillmentBoardDetailAssemblerTest {
	...
	private FulfillmentBoardDetailAssembler assembler;

	@BeforeEach
	void setUp() {
		repository = new FakeMeasurementRecordRepository();
		stackQuery = new FakeStackQueryUseCase();
		assembler = new FulfillmentBoardDetailAssembler(stackQuery, repository);
	}
