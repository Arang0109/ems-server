...
public enum ErrorCode {
  ...
  SCHEDULE_NOT_DELETABLE(HttpStatus.CONFLICT, "측정이 착수된 측정계획은 삭제할 수 없습니다. 취소를 사용해 주세요."),
  SCHEDULE_NOT_REOPENABLE(HttpStatus.CONFLICT, "완료되었거나 취소된 측정계획만 재개방할 수 있습니다."),
  SCHEDULE_REOPEN_FORBIDDEN(HttpStatus.FORBIDDEN, "완료된 측정계획의 재개방은 관리자만 할 수 있습니다."),
  SCHEDULE_ALREADY_DELETED(HttpStatus.CONFLICT, "이미 삭제된 측정계획입니다."),
  SCHEDULE_NOT_DELETED(HttpStatus.CONFLICT, "삭제되지 않은 측정계획은 복구할 수 없습니다."),
  ...
  POLLUTANT_REFERENCE_REQUIRED(HttpStatus.BAD_REQUEST, "측정물질 id 또는 카탈로그 id 중 하나는 필수입니다."),
