package com.ensolution.ems.client_management.presentation.company.controller;

import com.ensolution.ems.client_management.application.service.CompanyCommandService;
import com.ensolution.ems.client_management.application.service.CompanyQueryService;
import com.ensolution.ems.client_management.domain.Company;
import com.ensolution.ems.client_management.presentation.company.mapper.CompanyMapper;
...
public class CompanyController {
	...
	public ResponseEntity<ApiResponse<CompanyResponse>> createCompany(
		...
		Company savedCompany = companyCommandService.createCompany(mapper.toCreateCommand(request));
	...
	public ResponseEntity<ApiResponse<List<CompanyResponse>>> getCompanyList() {
		List<Company> companies = companyQueryService.getCompanyList();
	...
	public ResponseEntity<ApiResponse<CompanyResponse>> getCompany(
		...
		Company company = companyQueryService.getCompany(companyId);
	...
	public ResponseEntity<ApiResponse<CompanyResponse>> updateCompany(
		...
		Company modifiedCompany = companyCommandService.updateCompany(companyId, mapper.toUpdateCommand(request));
