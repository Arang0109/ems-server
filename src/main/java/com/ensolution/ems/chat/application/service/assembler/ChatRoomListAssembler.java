 ...
 *
 * <h2>조회 횟수를 고정합니다</h2>
 * 방이 몇 개든 <b>이름 조회 1회 + 미읽음 집계 1회</b>입니다.
 * <ul>
 ...
 * </ul>
 *
 * <p>접속 상태({@code online})는 아직 채우지 않습니다 — 프레즌스 저장소가 들어오면 여기서 조립합니다.
 */
@Component
...
public class ChatRoomListAssembler {
	...
	private ChatRoomListItem toListItem(ChatRoom room, UserSummary peer, long unreadCount) {
